 ...
 */
public class ExponentialXboxController extends XboxController implements Sendable {
     ...
     */
    public ExponentialXboxController(int port, ControllerMultiplierType exponent) {
        super(port);
        this.exponent = exponent;
        HAL.report(tResourceType.kResourceType_XboxController, port + 1);
    }

    public ControllerMultiplierType getExponent() {
        return exponent;
    }

    public void setExponent(ControllerMultiplierType exponent) {
        this.exponent = exponent;
    }

    @Override
    public double getRawAxis(int axis) {
        return Math.signum(super.getRawAxis(axis)) * Math.pow(Math.abs(super.getRawAxis(axis)), exponent.exponent);
    }
