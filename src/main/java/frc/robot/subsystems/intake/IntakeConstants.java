...
public class IntakeConstants {
    ...
    public static final double OPEN_POSITION = 0.385; //m
    ...
    static{
        ...
        intakeMotorConfig.motorConfig.motorType = DCMotor.getNeoVortex(1);
...
//        posConfig.profileConfig.maximumMeasurementAcceleration = 10;
    ...
    public static class ResetConstants{
        ...
        public static final double INITIAL_CURRENT_CHECK_FOR_CLOSE = 30;
        ...
        public static final double FINAL_CURRENT_CHECK_FOR_CLOSE = 35;
