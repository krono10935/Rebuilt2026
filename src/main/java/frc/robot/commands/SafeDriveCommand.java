...
public class SafeDriveCommand extends Command {
  ...
  public SafeDriveCommand(Drivetrain drivetrain, CommandXboxController controller) {
    ...
    MAX_ANGULAR_SPEED = drivetrain.getConstants().MAX_ANGULAR_SPEED / 2;
    MIN_ANGULAR_SPEED = drivetrain.getConstants().MIN_ANGULAR_SPEED / 2;
  }
